...
import { Palette, Users, Sparkles, Eye, Target, Heart, Layers, Zap } from 'lucide-react';
  ...
  const services = [
    {
      icon: Eye,
      title: 'User Research',
      description: 'Deep insights into user behavior, needs, and pain points through data-driven analysis.',
    },
    {
      icon: Sparkles,
      title: 'Interface Design',
      description: 'Pixel-perfect interfaces that balance aesthetics with usability and accessibility.',
    },
    {
      icon: Target,
      title: 'Interaction Design',
      description: 'Intuitive micro-interactions and animations that guide users effortlessly.',
    },
    {
      icon: Users,
      title: 'Usability Testing',
      description: 'Iterative testing with real users to validate design decisions and optimize flows.',
    },
    {
      icon: Layers,
      title: 'Design Systems',
      description: 'Scalable component libraries ensuring consistency across your product ecosystem.',
    },
    {
      icon: Heart,
      title: 'Brand Identity',
      description: 'Cohesive visual language that resonates with your target audience.',
    },
  ];
  ...
  const principles = [
    {
      ...
      description: 'Every design decision starts with understanding your users deeply.',
      icon: '🎯',
    },
    {
      title: 'Accessibility First',
      description: 'WCAG 2.1 compliant designs that work for everyone, everywhere.',
      icon: '♿',
    },
    {
    ...
    },
    {
      ...
      description: 'Strategic design patterns that guide users toward desired actions.',
      icon: '💰',
    },
  ];
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center space-x-2 mb-6 px-4 py-2 bg-white/5 backdrop-blur-sm rounded-full border border-pacific-cyan/30">
              ...
              <span className="text-pacific-cyan text-sm font-medium">UI/UX Design</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-white/70 max-w-3xl mx-auto mb-12 leading-relaxed">
              Craft intuitive, conversion-focused interfaces rooted in user-centric empathy and
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Industry-leading tools for prototyping, testing, and collaboration.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="p-12 rounded-2xl bg-gradient-to-br from-pacific-cyan/20 to-sky-blue/20 backdrop-blur-sm border border-pacific-cyan/30">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-heading font-bold text-4xl md:text-5xl text-white mb-6">
                Why Great Design <span className="text-pacific-cyan">Matters</span>
              </h2>
              <p className="text-xl text-white/80 mb-8 leading-relaxed">
                First impressions are formed in 50 milliseconds. Your interface is often the first
                interaction users have with your brand. We ensure it's memorable for the right
                reasons.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-6 rounded-xl bg-white/10 backdrop-blur-sm">
                  <div className="text-4xl font-heading font-bold text-pacific-cyan mb-2">400%</div>
                  <p className="text-white/70 text-sm">ROI increase with better UX design</p>
                </div>
                <div className="p-6 rounded-xl bg-white/10 backdrop-blur-sm">
                  <div className="text-4xl font-heading font-bold text-pacific-cyan mb-2">200%</div>
                  <p className="text-white/70 text-sm">Conversion rate improvement</p>
                </div>
                <div className="p-6 rounded-xl bg-white/10 backdrop-blur-sm">
                  <div className="text-4xl font-heading font-bold text-pacific-cyan mb-2">90%</div>
                  <p className="text-white/70 text-sm">Users judge credibility by design</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-white/70 mb-12 max-w-2xl mx-auto">
              Let's design an interface that delights users and drives business results.
            </p>
            <Link
              to="/contact"
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-pacific-cyan to-sky-blue text-white font-heading font-semibold rounded-lg hover:shadow-2xl hover:shadow-pacific-cyan/40 transition-all duration-300 transform hover:-translate-y-1"
