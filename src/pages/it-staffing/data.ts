...
export const ROLE_CATEGORIES: RoleCategory[] = [
  {
    ...
    roles: [
      ...
      { title: 'Database Administrator (PostgreSQL/SQL Server)', exp: '9+ yrs', rate: '$30/hr' },
  ...
  },
  {
    ...
    roles: [
      { title: 'Salesforce Administrator (ADV-Certified)', exp: '7+ yrs', rate: '$28/hr' },
      { title: 'Salesforce Developer (Apex/LWC)', exp: '6+ yrs', rate: '$32/hr' },
      { title: 'HubSpot Technical Specialist', exp: '5+ yrs', rate: '$24/hr' },
      { title: 'SAP S/4HANA Consultant', exp: '10+ yrs', rate: '$45/hr' },
      { title: 'Microsoft Dynamics 365 Consultant', exp: '8+ yrs', rate: '$38/hr' },
  ...
  },
  {
    ...
    icon: ShieldCheck,
    blurb: 'SOC, IAM, and penetration testing talent for regulated environments.',
    roles: [
      ...
      { title: 'Compliance Specialist (ISO 27001)', exp: '8+ yrs', rate: '$34/hr' },
  ...
  },
  {
    ...
    roles: [
      { title: 'Full-Stack Developer (React/Node)', exp: '6+ yrs', rate: '$30/hr' },
      { title: 'DevOps Engineer (Kubernetes/Terraform)', exp: '7+ yrs', rate: '$38/hr' },
      { title: 'Python Backend Engineer', exp: '5+ yrs', rate: '$28/hr' },
      { title: 'Mobile Developer (iOS/Android)', exp: '6+ yrs', rate: '$32/hr' },
      { title: 'Platform Engineer (ArgoCD/GitOps)', exp: '8+ yrs', rate: '$40/hr' },
      { title: 'SRE (Observability/Reliability)', exp: '7+ yrs', rate: '$42/hr' },
    ],
  },
  {
    id: 'qa',
    ...
    roles: [
      { title: 'Automation QA Engineer (Cypress/Playwright)', exp: '6+ yrs', rate: '$24/hr' },
      { title: 'BI Analyst (Power BI/Tableau)', exp: '7+ yrs', rate: '$28/hr' },
      { title: 'Data Engineer (Snowflake/dbt)', exp: '6+ yrs', rate: '$34/hr' },
      { title: 'AI/ML Implementer (Python/LLMs)', exp: '5+ yrs', rate: '$40/hr' },
...
export const TALENT_CARDS: TalentCard[] = [
  {
    ...
    role: 'Senior SOC & IAM Security Engineer',
    exp: '6+ yrs',
    certifications: ['CISSP', 'CompTIA Security+', 'ISO 27001 Lead'],
    stack: ['Splunk', 'Sentinel', 'Okta', 'Azure AD', 'CrowdStrike'],
    rate: '$36/hr',
  ...
  },
  {
    ...
    exp: '8+ yrs',
    certifications: ['Salesforce ADV-ADM', 'HubSpot Solutions', 'ServiceNow CSA'],
  ...
  },
  {
    ...
    exp: '9+ yrs',
    certifications: ['AWS Solutions Architect Pro', 'CKA', 'Terraform Associate'],
...
export const COMPARISON_ROWS: ComparisonRow[] = [
  ...
  { metric: 'Cost Overhead (Fully Loaded)', local: '$90–$140/hr', ours: '$22–$48/hr' },
  { metric: 'Replacement Guarantee', local: '30–60 day backfill', ours: '48-hour replacement' },
  { metric: 'Trial Period', local: 'Rarely offered', ours: '14-day, $0 risk' },
  { metric: 'Timezone Overlap', local: 'Same office only', ours: '4–5 hrs daily, or 24/7' },
];
...
export const TIMELINE_STEPS: TimelineStep[] = [
  ...
  },
  {
    ...
    description:
      'Receive 3–5 hand-picked, pre-vetted candidate resumes with rate cards and availability.',
  },
  {
    step: '03',
