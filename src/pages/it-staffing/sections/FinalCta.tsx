...
export default function FinalCta() {
  return (
    <section id="final-cta" className="scroll-mt-24 relative overflow-hidden bg-gradient-to-br from-deep-navy via-royal-blue to-deep-navy">
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-16 text-center sm:px-6 sm:py-24 lg:px-8">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-base text-white/70 sm:text-lg">
          Talk with an IT staffing specialist today. Get matched with certified CRM, Cloud,
          Security, or Development experts within 24 hours.
        </p>
