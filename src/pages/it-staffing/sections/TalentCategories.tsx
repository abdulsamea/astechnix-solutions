      ...
      <div className="mx-auto max-w-7xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-base text-white/70 sm:text-lg">
            Pre-screened, English-fluent specialists ready to integrate directly into your workflow.
          </p>
        </div>
          ...
          >
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {current.roles.map((r) => (
                ...
                >
                  <p className="text-base font-heading font-bold text-white">{r.title}</p>
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold text-pacific-cyan">{r.rate}</span>
                  </div>
                </div>
              ))}
            </div>
