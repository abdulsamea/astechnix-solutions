...
export default function EngagementModels({
  ...
  return (
    <section
      id="engagement"
      className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8 bg-white/5 backdrop-blur-sm"
    >
      <div className="mx-auto max-w-7xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-base text-white/70 sm:text-lg">
            Three ways to engage. Every model includes our 14-day risk-free
            trial and 48-hour replacement guarantee.
          </p>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/10 bg-white/5">
                  <th className="px-6 py-4 text-left text-sm font-heading font-bold text-white">
                    Metric
                  </th>
          ...
          <div className="mt-8 flex flex-col items-start gap-3 rounded-2xl bg-gradient-to-r from-deep-navy to-royal-blue p-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-white/70">
                Book a 15-minute call. We will recommend the right structure for
                your scope.
              </p>
            </div>
            <button
